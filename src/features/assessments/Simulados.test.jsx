...
vi.mock('../../services/student.js', () => ({
  createStudentMockExam: vi.fn(),
  deleteStudentMockExam: vi.fn(),
  getStudentMockExams: vi.fn(),
  updateStudentMockExam: vi.fn(),
}));
...
describe('Simulados', () => {
  ...
  it('creates, updates and deletes exams through the service layer', async () => {
    ...
    createStudentMockExam.mockResolvedValue({
      id: 'exam-2',
      name: 'FUVEST 2025',
      date: '2026-03-08',
      total: 90,
    ...
    updateStudentMockExam.mockResolvedValue({
      id: 'exam-1',
      name: 'ENEM 2024 - Dia 1',
      date: '2026-02-15',
      total: 90,
    ...
    await user.type(screen.getByLabelText('Total de questões'), '90');
    ...
    await waitFor(() => {
      expect(createStudentMockExam).toHaveBeenCalledWith({
        acertos: '80',
    ...
    await waitFor(() => {
      expect(updateStudentMockExam).toHaveBeenCalledWith('exam-1', expect.objectContaining({ acertos: '75' }));
    });
